...
class InputLayer:
    ...
    def forwardPropagate(self, input_layer: npt.ArrayLike) -> npt.ArrayLike:
        return (input_layer - self.mean) / self.std

    def backwardPropagate(self, input_layer: npt.ArrayLike) -> npt.ArrayLike:
        pass
...
class FullyConnectedLayer:
    def __init__(self, sizein, sizeout, eta):
        ...
        self.weights: npt.ArrayLike = 0.0001 * (np.random.rand(sizein, sizeout) - 0.5)
        self.biases: npt.ArrayLike = 0.0001 * (np.random.rand(1, sizeout) - 0.5)
    ...
    def backwardPropagate(self, gradient: npt.ArrayLike):
        ...
        # self.weights -= avg * (self.input_layer.T @ gradient)
...
class ReLuLayer:
    ...
    def backwardPropagate(self, in_grad: npt.ArrayLike) -> npt.ArrayLike:
